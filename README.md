...
Documentation: https://github.com/jesseduffield/lazydocker/tree/v0.25.2/docs
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/lazydocker-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lazydocker-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `lazydocker` available on your platform:
...
```
pixi search lazydocker --channel conda-forge
```
